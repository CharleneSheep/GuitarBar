...
if (isset($_GET['txt'])) {
    $txt = $_GET['txt'];
    $sql = "SELECT * FROM invitation WHERE name like '%$txt%'";
...
<head>
    ...
    <!-- 引入样式文件 -->
    <link rel="stylesheet" href="./css/alterInvitation.css">
    <link rel="stylesheet" href="./css/invList.css">
    <script src="./js/jquery-3.5.0.min.js"></script>
    <script src="./js/alterInvitation.js"></script>
</head>
...
<body>
            ...
            <div class="main">
                ...
                <div class="col-lg-10 main_right">
                    <div class="search_box">
                        <form action="">
                            <input type="search" name='searchInv' id="searchInv">
                    ...
                    <table class="table table-hover">
                        ...
                        ?>
                            <tr>
                                <td><?php echo $arr['invitId'] ?></td>
                                <td><?php echo $arr['u_Id'] ?></td>
                                <td><?php echo $arr['name'] ?></td>
                                <td><?php echo $arr['content'] ?></td>
                                <td><a onclick="editInv(<?php echo $arr['invitId'] ?>)" href="#">修改</a></td>
                                <td><a onclick="confirmDel(<?php echo $arr['invitId'] ?>)" href="#">删除</a></td>
                            </tr>
                        <?php } ?>
                    </table>
                </div>
    ...
    <script>
        function editInv(id) {
            location.href = './editInvitation.php?id=' + id; //get请求  除了表单发送的请求都是get请求
        }
    </script>
</body>
